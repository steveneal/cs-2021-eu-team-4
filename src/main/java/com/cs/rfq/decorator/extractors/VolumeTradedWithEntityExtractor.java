...
/**
 * The VolumeTradedWithEntityExtractor program implements a method that returns information of the number of trades
 * made by an entity over the past week, month and year.
 */
...
public class VolumeTradedWithEntityExtractor implements RfqMetadataExtractor {
    ...
    public Map<RfqMetadataFieldNames, Object> extractMetaData(Rfq rfq, SparkSession session, Dataset<Row> trades) {
        ...
        String query = String.format("SELECT SUM(LastQty) FROM trade WHERE EntityId = '%s' AND TradeDate >= ", rfq.getEntityId());
